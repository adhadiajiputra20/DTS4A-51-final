...
function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            >
                <h1 className="text-4xl font-semibold">Siap menonton? Masukkan email untuk Memulai {" "}</h1>
                <div className="flex flex-col gap-8 w-full max-w-[450px] px-16 py-14 my-10 rounded bg-black/70">
                    <h1 className="text-4xl font-semibold">Masuk</h1>
                    <form
